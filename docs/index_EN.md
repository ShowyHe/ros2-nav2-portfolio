# Documentation Index (Week1–Week8)

---

## Week1 (Bring-up + Fixed Protocol)
...
## Week2 (Pipeline Clarification: TF / costmap / planner-controller / BT recovery)
...
## Week3 (Evaluation Scripts and A/B Comparison: eval v0 → v2)
...
## Week4 (Minimal Parameter Study: baseline / A / B / A+B)
...
## Week5 (Scenario Generalization + Bag Replay)
...
## Week7 (Repository Conventions + Entry Points + Self-check List)
- `docs/week7_summary_packaging.md`

---

## Week8 (Single Entry: Evidence-Bound Packet)
- `docs/week8_ready_packet.md`

---

## Results Entry (Data Index)

### Entry Points
- Week1 baseline: `results/w1d6_baseline.csv`
- Week4 summary table: `results/week4_summary_table.csv`
- Week5 summary table: `results/week5_summary_table.csv`

### Notes
- `*_runs.csv`: raw per-run records (evidence data).
- `*_summary_table.csv`: primary entry for reading and comparison (conclusion entry).
